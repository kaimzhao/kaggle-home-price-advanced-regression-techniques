...
![4.3_categorical_boxplot](./image/4.2_categorical_boxplot.png)
...
Based on the EDA, categorical features are encoded using ordinal numbers based on the `SalePrice` mean. See the example with `Neighborhood` below:
